...
window.translations.en = {
    ...
    pollJitter: "Randomize polling interval",
    pollJitterDesc: "Vary auto-refresh timing (jitter) instead of a fixed interval, so dashboard polling looks less automated.",
    quotaCache: "Cache Quota Lookups",
    quotaCacheDesc: "Serve cached quota to the dashboard instead of calling Google on every refresh.",
    quotaCacheTtl: "Cache Duration",
    quotaCacheHint: "Manual refresh always fetches fresh. Reduces background Google calls from an idle dashboard.",
    ...
    tabApiKeys: "API Keys",
    apiKeysTitle: "Client API Keys",
    apiKeysDesc: "Manage the keys clients use to authenticate to the proxy's API. The legacy API_KEY env var still works alongside these.",
    apiKeysGenerate: "Generate Key",
    apiKeysLabelPlaceholder: "Optional label (e.g. laptop, ci-server)",
    apiKeysExisting: "Existing Keys",
    apiKeysEmpty: "No API keys yet. Generate one to require authentication.",
    apiKeysUnlabeled: "(unlabeled)",
    apiKeysEnabled: "Enabled",
    apiKeysDisabled: "Disabled",
    apiKeysRevoke: "Revoke key",
    apiKeysReveal: "Show key",
    apiKeysHide: "Hide key",
    apiKeysCopyKey: "Copy key",
    apiKeysRevealFailed: "Failed to reveal key",
    apiKeysRevokeConfirm: "Revoke API key \"{label}\"? Clients using it will stop working.",
    apiKeysOpenWarning: "No enabled keys and no legacy key — the proxy currently accepts any request.",
    apiKeysCreatedTitle: "Key created — copy it now",
    apiKeysCreatedDesc: "Copy your key now. You can also reveal it later from the list using the eye button.",
    apiKeysDismiss: "Dismiss",
    apiKeysCreatedToast: "API key created",
    apiKeysRevokedToast: "API key revoked",
    apiKeysCopied: "Key copied to clipboard",
    apiKeysCopyFailed: "Failed to copy key",
    apiKeysFetchFailed: "Failed to load API keys",
